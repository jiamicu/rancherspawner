...
**RancherSpawner** enables [JupyterHub](https://github.com/jupyterhub/jupyterhub) 
to spawn single user notebook servers with rancher ui-api.
...
Two basic types of spawners are available for RancherSpawner:

- [RancherSpawner](#RancherSpawner): useful if you would like to spawn 
...
Tell JupyterHub to use RancherSpawner by adding the following line to 
